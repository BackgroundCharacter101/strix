...
> _Snapshot date: 2026-07-05 · ~269 commits · 420 tests passing (61 files)._
>
...
| Tests | **Vitest** + Testing Library (420 tests) |
...
- **420 automated tests** (Vitest), all green. Pure logic (search, hex dump,
