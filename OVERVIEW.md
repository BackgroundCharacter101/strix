...
> _Snapshot date: 2026-07-05 · ~269 commits · 441 tests passing (65 files)._
>
...
| Tests | **Vitest** + Testing Library (441 tests) |
...
- **441 automated tests** (Vitest), all green. Pure logic (search, hex dump,
