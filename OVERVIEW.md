...
> _Snapshot date: 2026-07-05 · ~269 commits · 391 tests passing (56 files)._
>
...
| Tests | **Vitest** + Testing Library (391 tests) |
...
- **391 automated tests** (Vitest), all green. Pure logic (search, hex dump,
