...
> _Snapshot date: 2026-07-05 · ~265 commits · 387 tests passing (56 files)._
>
...
| Tests | **Vitest** + Testing Library (387 tests) |
...
- **387 automated tests** (Vitest), all green. Pure logic (search, hex dump,
