...
> _Snapshot date: 2026-05-30 · ~94 commits · 166 tests passing._
...
| Tests | **Vitest** + Testing Library (166 tests) |
...
- **166 automated tests** (Vitest), all green. Pure logic (search, hex dump,
